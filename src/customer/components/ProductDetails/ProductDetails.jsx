...
const product = {
  ...
  description:
    'The Basic Tee allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: "Black". Need to add an extra pop of color to your outfit? Our white tee has you covered.',
  highlights: [
...
export default function ProductDetails() {
  ...
  const handleAddToCart = () => {
    ...
    console.log("handle add item to cart: ", data)
    dispatch(addItemToCart(data))
    navigate("/cart");
  }

  const discountPresent = products.product?.price && products.product?.discountedPrice
  ? Math.round(((products.product.price - products.product.discountedPrice) / products.product.price) * 100)
  : 0;
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 item-center text-lg lg:text-xl text-gray-900 mt-6">
                ...
                <p className="font-semibold text-green-600">{discountPresent}% off</p>                
              </div>

              {/* Reviews */}
              <div className="mt-6">
                <div className="flex item-center">
                  <Rating name="disabled" value={3.5} disabled />
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex item-center space-x-3">
                  ...
                  <p className="opacity-60">5634 Ratings</p>
                </div>
                ...
                <Box className="mt-5 space-y-3">
                  ...
                  <Grid container alignItems="center" gap={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7}} variant="determinate" value={22} color="warning" />
                    </Grid>
                  </Grid>
                  <Grid container alignItems="center" gap={2}>
                    <Grid item xs={2}>
